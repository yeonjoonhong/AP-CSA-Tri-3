...
import src.util.LinkedList1;

public class Queue<T> implements Iterable<T> {
    LinkedList1<T> head, tail;

    public void add(T data) {
        // add new object to end of Queue
        LinkedList1<T> tail = new LinkedList1<T>(data, null);
...
class QueueIterator<T> implements Iterator<T> {
    LinkedList1<T> current;  // current element in iteration
